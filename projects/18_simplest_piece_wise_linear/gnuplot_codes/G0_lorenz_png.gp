...
set output "G0_lorenz_oscillator_xy_float.png"
plot filename using 1:2 with lines linestyle graph_style

set output "G0_lorenz_oscillator_xz_float.png"
plot filename using 1:3 with lines linestyle graph_style

set output "G0_lorenz_oscillator_yz_float.png"
plot filename using 2:3 with lines linestyle graph_style

set output "G0_lorenz_oscillator_3d_float.png"
set view 65, 50
set xyplane at 0
